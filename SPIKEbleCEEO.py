code = '''## modified for using LEGO IDs
...
UART_SERVICE_UUID = bluetooth.UUID('0000fd02-0000-1000-8000-00805f9b34fb')
UART_RX_CHAR_UUID = bluetooth.UUID('0000fd02-0001-1000-8000-00805f9b34fb')
UART_TX_CHAR_UUID = bluetooth.UUID('0000fd02-0002-1000-8000-00805f9b34fb')
